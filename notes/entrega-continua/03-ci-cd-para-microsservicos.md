...
- **Testes automatizados**: a suíte de testes do serviço roda, cobrindo desde testes unitários rápidos até testes de contrato entre serviços (aprofundado em [Testes em Microsserviços](/labs/web-dev/engenharia-de-software/04-testes-em-microsservicos/)).
