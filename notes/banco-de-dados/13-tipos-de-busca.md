...
Esse tipo tem nota própria, com exemplos em PostgreSQL e MySQL: [Busca Full-Text](/labs/web-dev/banco-de-dados/14-busca-full-text-search/). Vale a regra de lá: para a maioria das caixas de busca (produto, artigo, comentário, documentação), o full-text nativo do banco resolve sem subir infraestrutura nova.
