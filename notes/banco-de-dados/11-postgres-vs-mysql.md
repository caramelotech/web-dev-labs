...
- **Precisa de tipos de índice especializados** (JSONB com GIN, [busca full-text](/labs/web-dev/banco-de-dados/15-busca-full-text-search/), dados geográficos com PostGIS): o Postgres tem um leque bem maior aqui.
