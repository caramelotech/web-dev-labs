...
**Append-only / event sourcing.** Nunca se altera nem se apaga nada, apenas se registra o evento "cliente desativado". É a mesma ideia do [Ledger Pattern](/labs/web-dev/banco-de-dados/09-ledger-pattern/), generalizada para qualquer entidade em vez de só saldo.
