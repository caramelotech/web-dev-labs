...
Todo banco ACID escreve num log antes de confirmar uma mudança, para conseguir recuperar depois de uma queda de energia (é o **D** de Durabilidade em [ACID](/labs/web-dev/banco-de-dados/04-acid/)). O número e o papel desses logs difere bastante.
...
- **Replicação**: as réplicas recebem o WAL do primário e o reproduzem para ficar em sincronia (a "replicação baseada em WAL" citada na nota de [Escolha de Banco de Dados](/labs/web-dev/banco-de-dados/07-escolha-de-banco-de-dados/)).
...
- **Precisa de tipos de índice especializados** (JSONB com GIN, [busca full-text](/labs/web-dev/banco-de-dados/16-busca-full-text-search/), dados geográficos com PostGIS): o Postgres tem um leque bem maior aqui.
