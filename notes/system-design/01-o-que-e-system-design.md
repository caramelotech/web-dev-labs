...
- **Consistência**: garantia sobre o que diferentes partes do sistema (ou diferentes usuários) enxergam como o estado atual dos dados. Aprofundada em [Consistência e Replicação](/labs/web-dev/sistemas-distribuidos/01-consistencia-e-replicacao/) e no [Teorema de CAP](/labs/web-dev/banco-de-dados/05-teorema-de-cap/).
