...
- **Banco de dados**: queries mal otimizadas, [falta de índice](/labs/web-dev/banco-de-dados/13-indices-e-planos-de-execucao/), ou o banco simplesmente recebendo mais tráfego do que consegue processar (veja [Database bottlenecks](/labs/web-dev/escalabilidade/03-replicacao-de-banco-de-dados/)).
