...
- **Locks e contenção**: estratégias de concorrência mal escolhidas (veja [Controle de Concorrência](/labs/web-dev/banco-de-dados/08-controle-de-concorrencia/)) podem travar o sistema mesmo com hardware sobrando.
