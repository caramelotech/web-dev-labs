...
- **Lock contention**: quando muitas transações competem pelo mesmo lock (veja [Controle de Concorrência](/labs/web-dev/banco-de-dados/08-controle-de-concorrencia/)), elas ficam na fila esperando, e o tempo de resposta do banco sobe mesmo que a CPU esteja ociosa.
