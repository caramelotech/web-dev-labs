...
| Fundamentos de sistemas          | [HTTP e REST](/labs/web-dev/apis/01-http-rest/), [ACID](/labs/web-dev/banco-de-dados/04-acid/), [Escalabilidade](/labs/web-dev/escalabilidade/01-escalabilidade/), [Consistência e Replicação](/labs/web-dev/sistemas-distribuidos/01-consistencia-e-replicacao/) e o restante do lab |
