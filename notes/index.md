...
- **Sistemas Distribuídos** - quando os dados vivem em várias máquinas: consistência e replicação
...
- **Entrega Contínua** - do commit ao ar: containers, Kubernetes e CI/CD
